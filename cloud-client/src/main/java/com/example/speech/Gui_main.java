...
public class Gui_main extends JFrame{
   ...
   synchronized public static void speech(){
     ...
     */
      ...
      private static final int STREAMING_LIMIT = 3000; // ~5 minutes
      ...
      synchronized public static void infiniteStreamingRecognize(String languageCode) throws Exception {
