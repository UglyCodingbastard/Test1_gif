...
sql1 = 'select * from study_test.test1' #test1 출력
sql2 = "insert into study_test.test1(Date, Note, Count, Ea)values(%s, %s, %s, %s)"#test1 입력
sql3 = "insert into study_test.EA_table(EA)values(%s)"  #티켓 수량 입력
sql4 = 'select * from study_test.test1 where Ea OR NULL' #값이 있는 것 만 출력
sql5 = "insert into study_test.test1(Ea)values(%s)"#test1 입력
